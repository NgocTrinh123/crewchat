...
/**
 * Created by THANHTUNG on 25/02/2016.
 */
...
public class LoggingService extends IntentService {
    ...
    public static final String ACTION_LOG = Statics.APPLICATION_ID + ".LOG";
    public static final String ACTION_CLEAR_LOGS = Statics.APPLICATION_ID + ".CLEAR_LOGS";
